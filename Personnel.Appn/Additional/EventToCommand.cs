...
namespace Personnel.Appn.Additional
{
    ...
    public partial class EventToCommand : TriggerAction<DependencyObject>
    {
        ...
        protected override void Invoke(object parameter)
        {
            ...
            object eventArgsParameter = null;

            if (PassEventArgsToCommand)
            {
                eventArgsParameter = EventArgsConverter == null
                    ? parameter
                    : EventArgsConverter.Convert(parameter, EventArgsConverterParameter);

                if (commandParameter == null)
                    commandParameter = eventArgsParameter;
                else
                    commandParameter = new EventArgsParameter(commandParameter, eventArgsParameter);
            }
